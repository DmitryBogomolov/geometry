...
class TestRelations3(unittest.TestCase):
    def test_project_point_line(self):
        line = Line3(anchor=Vec3(0, 3, 0), direction=Vec3(2, 0, 2))
        self.assertEqual(r3.project_point_line(Vec3(1, 3, 1), line), Vec3(1, 3, 1))
        self.assertEqual(r3.project_point_line(Vec3(4, 3, 4), line), Vec3(4, 3, 4))
        self.assertEqual(r3.project_point_line(Vec3(2, 0, 2), line), Vec3(2, 3, 2))
        self.assertEqual(r3.project_point_line(Vec3(4, 3, 0), line), Vec3(2, 3, 2))
